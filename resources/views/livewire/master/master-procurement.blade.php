            ...
            <div class="card card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('procurement') is-invalid @enderror"
                            wire:model="procurement">
                        @error('procurement')
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Master Procurement</h5>
                ...
                <div wire:target="updateConfirm" wire:loading.remove>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-label required">Procurement</label>
                                <input type="text" class="form-control @error('procurement_') is-invalid @enderror"
                                    wire:model="procurement_">
                                @error('procurement_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
