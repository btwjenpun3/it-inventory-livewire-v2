    ...
    <div id="create-collapse" class="accordion-collapse collapse mb-3" wire:ignore.self>
        <div class="accordion-body pt-0">
            <div class="card card-body">
                <div class="row">
                    <div class="col-md-6">
                        <label class="form-label required">Code Buyer</label>
                        <input type="text" class="form-control @error('code_buyer') is-invalid @enderror"
                            wire:model="code_buyer">
                        @error('code_buyer')
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Data Buyer</h5>
                        ...
                        <div class="card card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="form-label required">Code Buyer</label>
                                    <input type="text"
                                        class="form-control @error('code_buyer_') is-invalid @enderror"
                                        wire:model="code_buyer_">
                                    @error('code_buyer_')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label required">Buyer Name</label>
                                    <input type="text"
                                        class="form-control @error('buyer_name_') is-invalid @enderror"
                                        wire:model="buyer_name_">
                                    @error('buyer_name_')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mt-3">
                                    <label class="form-label">Email</label>
                                    <input type="email" class="form-control @error('email_') is-invalid @enderror"
                                        wire:model="email_">
                                    @error('email_')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
