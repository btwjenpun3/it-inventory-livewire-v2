    ...
    <div id="create-collapse" class="accordion-collapse collapse mb-3" wire:ignore.self>
        <div class="accordion-body pt-0">
            <div class="card card-body">
                <div class="row">
                    <div class="col-md-6">
                        <label class="form-label required">BOM Level</label>
                        <input type="text" class="form-control @error('bom_level') is-invalid @enderror"
                            wire:model="bom_level">
                        @error('bom_level')
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Master BOM Level</h5>
                ...
                <div wire:target="updateConfirm" wire:loading.remove>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-label required">BOM Level</label>
                                <input type="text" class="form-control @error('bom_level_') is-invalid @enderror"
                                    wire:model="bom_level_">
                                @error('bom_level_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
