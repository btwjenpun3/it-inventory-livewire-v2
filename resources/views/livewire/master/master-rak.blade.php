    ...
    <div id="create-collapse" class="accordion-collapse collapse mb-3" wire:ignore.self>
        <div class="accordion-body pt-0">
            <div class="card card-body">
                <div class="row">
                    <div class="col-md-6">
                        <label class="form-label required">Rak Code</label>
                        <input type="text" class="form-control @error('rak_code') is-invalid @enderror"
                            wire:model="rak_code">
                        @error('rak_code')
                    ...
                    <div class="col-md-6">
                        <label class="form-label required">Rak Name</label>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Master Rak</h5>
                ...
                <div wire:target="updateConfirm" wire:loading.remove>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-label required">Rak Code</label>
                                <input type="text" class="form-control @error('rak_code_') is-invalid @enderror"
                                    wire:model="rak_code_">
                                @error('rak_code_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label required">Rak Name</label>
                                <input type="text" class="form-control @error('rak_name_') is-invalid @enderror"
                                    wire:model="rak_name_">
                                @error('rak_name_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
