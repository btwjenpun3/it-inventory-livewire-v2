    ...
    <div id="create-collapse" class="accordion-collapse collapse mb-3" wire:ignore.self>
        <div class="accordion-body pt-0">
            <div class="card card-body">
                <div class="row">
                    <div class="col-md-12">
                        <label class="form-label required">Jenis Tujuan</label>
                        <input type="text" class="form-control @error('jrnis_tujuan') is-invalid @enderror"
                            wire:model="jrnis_tujuan">
                        @error('jrnis_tujuan')
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Master Jenis Tujuan</h5>
                ...
                <div wire:target="updateConfirm" wire:loading.remove>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <label class="form-label required">Jenis Tujuan</label>
                                <input type="text" class="form-control @error('jenis_tujuan_') is-invalid @enderror"
                                    wire:model="jenis_tujuan_">
                                @error('jenis_tujuan_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
