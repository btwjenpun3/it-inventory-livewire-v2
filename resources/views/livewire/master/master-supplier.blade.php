        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Master Supplier</h5>
                ...
                <div wire:target="updateConfirm" wire:loading.remove>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-label required">Supplier Code</label>
                                <input type="text" class="form-control @error('supplier_code_') is-invalid @enderror"
                                    wire:model="supplier_code_">
                                @error('supplier_code_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label required">Supplier Name</label>
                                <input type="text" class="form-control @error('supplier_name_') is-invalid @enderror"
                                    wire:model="supplier_name_">
                                @error('supplier_name_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mt-3">
