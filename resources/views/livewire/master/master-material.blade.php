            ...
            <div class="card card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        @else
                            <p>
                                <i>Belum ada Data. Harap buat <a href="{{ route('master.material.type') }}">Master
                                        Material Type</a> terlebih dahulu!</i>
                            </p>
                            @error('material_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        @if (count($satuan) > 0)
                            <select class="form-select @error('satuan_id') is-invalid @enderror" wire:model="satuan_id">
                                <option value="">-- Pilih --</option>
                                @foreach ($satuan as $s)
                        ...
                        @else
                            <p>
                                <i>Belum ada Data. Harap buat <a href="{{ route('master.satuan') }}">Master
                                        Satuan</a> terlebih dahulu!</i>
                            </p>
                            @error('satuan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div wire:target="updateConfirm" wire:loading.remove>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-label required">Material Code</label>
                                <input type="text" class="form-control @error('material_code_') is-invalid @enderror"
                                    wire:model="material_code_">
                                @error('material_code_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6 mt-3">
                                <label class="form-label required">Material Type</label>
                                <select class="form-select @error('material_type_id_') is-invalid @enderror"
                                    wire:model="material_type_id_">
                                    <option value="">-- Pilih --</option>
                                    @foreach ($material as $m)
                                        <option value="{{ $m->id }}">{{ $m->material_type }}</option>
                                    @endforeach
                                </select>
                                @error('material_type_id_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mt-3">
                                <label class="form-label required">Satuan</label>
                                <select class="form-select @error('satuan_id_') is-invalid @enderror"
                                    wire:model="satuan_id_">
                                    <option value="">-- Pilih --</option>
                                    @foreach ($satuan as $s)
                                        <option value="{{ $s->id }}">{{ $s->satuan }}</option>
                                    @endforeach
