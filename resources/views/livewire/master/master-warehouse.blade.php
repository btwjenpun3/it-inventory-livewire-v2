        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Master Warehouse</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-label required">Warehouse Code</label>
                                <input type="text"
                                    class="form-control @error('warehouse_code_') is-invalid @enderror"
                                    wire:model="warehouse_code_">
                                @error('warehouse_code_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label required">Warehouse Name</label>
                                <input type="text"
                                    class="form-control @error('warehouse_name_') is-invalid @enderror"
                                    wire:model="warehouse_name_">
                                @error('warehouse_name_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
