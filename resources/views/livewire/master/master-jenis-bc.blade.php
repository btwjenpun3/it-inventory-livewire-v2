            ...
            <div class="card card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('jenis_bc') is-invalid @enderror"
                            wire:model="jenis_bc">
                        @error('jenis_bc')
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Master Jenis BC</h5>
                ...
                <div wire:target="updateConfirm" wire:loading.remove>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-label required">Jenis BC</label>
                                <input type="text" class="form-control @error('jenis_bc_') is-invalid @enderror"
                                    wire:model="jenis_bc_">
                                @error('jenis_bc_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label required">Keterangan</label>
                                <input type="text" class="form-control @error('keterangan_') is-invalid @enderror"
                                    wire:model="keterangan_">
                                @error('keterangan_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
