            ...
            <div class="card card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control @error('material_type') is-invalid @enderror"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Master Material Type</h5>
                ...
                <div wire:target="updateConfirm" wire:loading.remove>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <label class="form-label required">Material Type</label>
                                <input type="text" class="form-control @error('material_type_') is-invalid @enderror"
                                    wire:model="material_type_">
                                @error('material_type_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
