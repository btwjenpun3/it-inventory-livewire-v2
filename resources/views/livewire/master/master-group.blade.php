            ...
            <div class="card card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control @error('group') is-invalid @enderror" wire:model="group">
                        @error('group')
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Master Group</h5>
                ...
                <div wire:target="updateConfirm" wire:loading.remove>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <label class="form-label required">Group</label>
                                <input type="text" class="form-control @error('group_') is-invalid @enderror"
                                    wire:model="group_">
                                @error('group_')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
